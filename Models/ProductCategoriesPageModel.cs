...
namespace ResoldProducts.Models
{
    public class ProductCategoriesPageModel:PageModel
    {
        ...
        public void PopulateAssignedCategoryData(ResoldProductsContext context, Product product) 
        {
        ...
        public void UpdateProductCategories(ResoldProductsContext context, string[] selectedCategories, Product productToUpdate)
        {
